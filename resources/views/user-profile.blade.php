...
<head>
    ...
    <!-- Page Title  -->
    <title>My Profile | DashLite Admin Template</title>
    <!-- StyleSheets  -->
                                                ...
                                                <div class="card-inner-group" data-simplebar>
                                                    ...
                                                    <div class="card-inner p-0">
                                                        <ul class="link-list-menu nav nav-tabs">
                                                            <li><a data-bs-toggle="tab" href="#personal" class="active" href="#"><em class="icon ni ni-user-fill-c"></em><span>Personal Infomation</span></a></li>
                                                            <li><a data-bs-toggle="tab" href="#notification" href="#"><em class="icon ni ni-bell-fill"></em><span>Notifications</span></a></li>
                                                            <li><a data-bs-toggle="tab" href="#settings" href="#"><em class="icon ni ni-lock-alt-fill"></em><span>Security Settings</span></a></li>
                                                            <li><a data-bs-toggle="tab" href="#activity" href="#"><em class="icon ni ni-activity-round-fill"></em><span>Account Activity</span></a></li>
                                                        </ul>
                                                    </div><!-- .card-inner -->
                                                </div><!-- .card-inner-group -->
                                            </div><!-- card-aside -->
