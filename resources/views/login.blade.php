...
<head>
    <base href="../../../">
    <meta charset="utf-8">
    <meta name="author" content="Speedmart">
                    ...
                    <div class="nk-block nk-block-middle nk-auth-body  wide-xs">
                        <div class="brand-logo pb-4 text-center">
                            <a href="html/index.html" class="logo-link">
                                ...
                                <img class="logo-dark logo-img logo-img-lg" src="./images/logo.png" srcset="./images/logo-dark2x.png 2x" alt="logo">
                            </a>
                        </div>
                                ...
                                <div class="nk-block-head">
                                    <div class="nk-block-head-content">
                                        ...
                                        <div class="nk-block-des">
                                            <p class="text-center">Access the Karihaalan panel using your email and passcode.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                @csrf
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control form-control-lg" id="default-01" placeholder="Enter your email address or username" name="phone">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="form-label-group">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-lg-6">
                                    <div class="nk-block-content text-center text-lg-left">
                                        <p class="text-soft">&copy; {{$year}} Karihaalan. All Rights Reserved.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
